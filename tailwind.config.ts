...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        soft: "0 1px 2px hsl(240 8% 10% / 0.04), 0 1px 3px hsl(240 8% 10% / 0.05)",
        card: "0 2px 8px hsl(240 8% 10% / 0.06)",
        lift: "0 8px 24px hsl(240 8% 10% / 0.08)",
        glow: "0 8px 32px hsl(252 80% 60% / 0.25)",
      },
      keyframes: {
        "fade-in": {
